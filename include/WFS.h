/****************************************************************************
	...
	Copyright:  Copyright(c) 2023, Thorlabs GmbH (www.thorlabs.com)
...
#define CAM_MAXPIX_X                  		 (2048)  // minimum image buffer size is CAM_MAXPIX_X * CAM_MAXPIX_Y
#define CAM_MAXPIX_Y                         (2048)
...
#define MAX_CAM_DRIVER_ERRORS                (33000) // camera driver errors in range 1 .. MAX_CAM_DRIVER_ERRORS
...
#define  MASTER_GAIN_MAX_WFS31         (20.0) // analog 20.1836
...
#define  BLACK_LEVEL_WFS31_DEF         (0)
#define  BLACK_LEVEL_WFS31_MAX         (31.9375)
...
// pre-defined image sizes for WFS31 instruments
#define  CAM_RES_WFS31_1920           (0) // 1920x1200
#define  CAM_RES_WFS31_1200           (1) // 1200x1200
#define  CAM_RES_WFS31_1024           (2) // 1024x1024
#define  CAM_RES_WFS31_768            (3) // 768x768
#define  CAM_RES_WFS31_512            (4) // 512x512
#define  CAM_RES_WFS31_368            (5) // 368x368 smallest!
#define  CAM_RES_WFS31_968_SUB2       (6) // 968x608, subsampling 2x2
#define  CAM_RES_WFS31_608_SUB2       (7) // 608x608, subsampling 2x2
#define  CAM_RES_WFS31_512_SUB2       (8) // 512x512, subsampling 2x2
#define  CAM_RES_WFS31_384_SUB2       (9) // 384x384, subsampling 2x2
#define  CAM_RES_WFS31_256_SUB2       (10) // 256x256, subsampling 2x2
#define  CAM_RES_WFS31_184_SUB2       (11) // 184x184, subsampling 2x2
#define  CAM_RES_WFS31_MAX_IDX        (11)
...
// number, order frequency name
	...
	{  8,    3,   -1,    "Coma y",                 }, // corrected x->y 7.7.2022
	{  9,    3,    1,    "Coma x",                 }, // corrected y->x 7.7.2022  
